...
function loadSong(songList ){
    ...
    document.getElementById('image_shower').src = `src/img/${imageList[i]}`;
}
...
function prevSong() {
    ...
    console.log('Canción anterior:', songList[i].songName);
    loadSong(songList[i]);
    playSong();
}
...
function nextSong() {
    ...
    console.log('Canción siguiente:', songList[i].songName);
    loadSong(songList[i]);
    playSong();
}
